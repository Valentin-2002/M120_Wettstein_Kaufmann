...
public class RaceCar {
	...
	private static String DEAFULT_MANUFACTURER = "Manufacturer";
	...
	private SimpleStringProperty manufacturer = new SimpleStringProperty(DEAFULT_MANUFACTURER);

	// the built year of the car
	private SimpleIntegerProperty year = new SimpleIntegerProperty(DEFAULT_YEAR);
	...
	/**
	 * @param manufacturer
	 *            the manufacturer of the car to be set
	 */
	 ...
	 */
	public StringProperty manufacturerProperty() {return this.manufacturer; }

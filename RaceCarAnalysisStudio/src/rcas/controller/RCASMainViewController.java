...
public class RCASMainViewController {
	...
	public void initialize() {
		...
		myRaceCar_1.setName("Skyline GTR");
		myRaceCar_1.setManufacturer("Nissan");
		myRaceCar_1.setYear(1999);

		RaceCar myRaceCar_2 = new RaceCar(410, 410, 390, 390);
		...
		myRaceCar_2.setName("Shelby Cobra");
		myRaceCar_2.setManufacturer("Ford");
		myRaceCar_2.setYear(1987);
